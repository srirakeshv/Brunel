...
const Banner = () => {
  return (
    <div className="px-3 pt-3 mb-32">
      <div className="p-4 flex flex-col items-center">
        <h5
          className="text-center font-coverbyyourgrace text-4xl"
          style={{ color: "#2DA950" }}
        >
          Success stories
        </h5>
        <h2 className="mt-4 text-center text-6xl font-semibold font-manrope w-[688px]">
          Every success journey we've encountered.
        </h2>
        <div className="self-start flex gap-44 mt-20 pl-4">
          {/*  */}
          <div className="relative">
            <div
              className="rounded-2xl pl-36"
              style={{ width: "546px", height: "546px" }}
            >
              <img
                src={`${process.env.PUBLIC_URL}/asset/bannerimage/BannerImage.png`}
                alt="Bannerimage"
                className="rounded-2xl w-full h-full"
              />
            </div>
            <div
              className="absolute -bottom-10 -right-24 rounded-2xl p-5 py-7 text-white flex flex-col gap-5 w-72"
              style={{ backgroundColor: "#002E18" }}
            >
              <p className="text-6xl">
                $0.5{" "}
                <span className="text-xl" style={{ color: "#A6A3A0" }}>
                  MILLION
                </span>
              </p>
              <p className="font-manrope text-lg" style={{ color: "#A6A3A0" }}>
            ...
            <div className="absolute bottom-10 left-20 flex gap-4 rounded-full p-3 px-4 bg-white shadow-sm shadow-slate-200">
              ...
              <div>
                <h3 className="text-2xl text-black font-bold">10 DAYS</h3>
            ...
            <div className="box-content absolute top-20 left-3 w-44 p-3 px-5 rounded-2xl bg-white shadow-sm shadow-slate-200">
              ...
              <h2 className="text-6xl font-sans font-semibold">40%</h2>
              <p style={{ color: "#828282" }} className="text-base">
          ...
          <div className="flex flex-col">
            <p
              className="mt-20 font-manrope font-semibold text-[40px] w-[398px]"
